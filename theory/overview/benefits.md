...
{% hint style="info" %}
Options writers with BIOP tokens become investor-owners and act as the house. This provides a benefit rarely observed in centralized binary options trading platforms.
{% endhint %}
...
It is highly recommended that voting power only ever be delegated to predeployed audited smart contracts making the desired change instead of delegating to a human's address.
